    ...
    async remove(id) {
        await fetch(`/course/${id}`, {
            ...
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
                'Authorization':'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJwYW5rYWp3YWdoQGdtYWlsLmNvbSIsImlhdCI6MTcyMDQ5MjIyMSwiZXhwIjoxNzIwNDk1ODIxfQ.72gdvk4JN-07HwpL-ngjRD3JcnqEK1DKYRpx-eoNu0U'
            }
        }).then(() => {
